...
def plot_metrics(baseline_metrics, lora_metrics, output_path):
    ...
    lora_scores = [lora_metrics[m] for m in metrics]
...
if __name__ == "__main__":
    baseline_metrics = {'BLEU-1': 0.60, 'BLEU-4': 0.25, 'CIDEr': 0.80, 'ROUGE-L': 0.45}
    lora_metrics = {'BLEU-1': 0.63, 'BLEU-4': 0.28, 'CIDEr': 0.87, 'ROUGE-L': 0.48}
